...
<body>
                ...
                <div class="navbar-custom">
                    <div class="top-menus-wrapper">
                        <div class="top-menus-content">
                            <span class="top-menus-item"><span class="top-menu-title">合同管理</span></span>
    ...
    <div style="display: flex;">
            ...
            <div data-v-4d4bf192="" class="menu-wrapper submenu-container" data-menu-name="合同管理" style="display: none;">
                <ul role="menu" class="el-menu el-menu--inline contract-menu" style="background-color: rgb(245, 247, 249); box-shadow: inset 0 2px 5px rgba(0,0,0,0.05); border-radius: 4px; margin: 5px 0;">
                        <a href="#/contractServiceConfirmation" style="text-decoration: none;">
                            <li role="menuitem" tabindex="-1" class="el-menu-item" style="padding-left: 40px; color: rgb(86, 94, 109); background-color: rgb(245, 247, 249); font-size: 14px; font-family: 'Microsoft YaHei', Arial, sans-serif; margin: 2px 0; border-radius: 4px;">
                                <span>服务确认</span>
                            </li>
                        </a>
        ...
        <div id="mainContent" style="flex: 1; padding: 20px;">
            <?php include __DIR__.'/app/views/dashboard/workspace.php'; ?>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 每30秒自动刷新数据
            setInterval(refreshWorkspaceData, 30000);
            
            // 为顶部菜单添加点击事件
            const topMenuItems = document.querySelectorAll('.top-menus-item');
            
            // 激活默认菜单（合同管理）
            document.querySelector('.top-menus-item .top-menu-title').textContent = '合同管理';
